...
algorithms = ['CDEL_BB_inference','Adaptive_predictor','HistGradientBoostingRegressor','SVR','LinearRegression']
...
alg_rename = {'CDEL_BB_inference':'CEDL (Proposed)',
              'LinearRegression':'LR',
...
fig.legend(prop={'size': fs-1},loc=(0.75,0.3))
